...
git rm -r --cached projects/ai-handoff-system/ 2>/dev/null || true
git rm --cached AI_HANDOFF_QUICK_SETUP.md 2>/dev/null || true
git rm --cached scripts/setup-ai-handoff-environment.sh 2>/dev/null || true
